...
class PLAIN(nn.Module):
  def __init__(self, conv_config, num_classes,pruned=False):
...
def plain20pr(num_classes=10,pruned=True):#3, 8, 8, 8, 8, 16, 8, 16, 24, 24, 24, 24, 24, 32, 56, 56, 56, 56, 16, 16
  return PLAIN(conv_config=[16, 8, 8, 16, 8, 16,'M',
                            16, 24, 24, 24, 32, 32,  'M',
                            40, 48, 48, 56, 16, 16,'M'],
               #3, 16, 8, 8, 16, 8, 16, 16, 24, 24, 24, 32, 32, 40, 48, 48, 56, 16, 16
#,16, 8, 16, 8, 8, 16, 16, 24, 32, 24, 24, 32, 40, 48, 48, 56, 16, 16
               num_classes=num_classes,pruned=pruned)
