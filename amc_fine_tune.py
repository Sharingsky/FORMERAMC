...
def parse_args():
    ...
    parser.add_argument('--model', default='plain20pr', type=str, help='name of the model to train')
    ...
    # resume
    parser.add_argument('--ckpt_path', default='./prunedmodel/palin20pruned2.pkl', type=str, help='checkpoint path to resume from')
...
def get_model():
    ...
    elif args.model == 'plain20':
        from models.cifar_plain import plain20
        net = plain20(10)
    elif args.model == 'plain20pr':
